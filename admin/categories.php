...
?>
        ...
        <div class="container categories">
            <ul class="list-group">
                        <li class="list-group-item" style="background-color:#EEE; color:#959595; font-weight:bold;">
                            <i class="fa fa-edit" style="position:relative;top:1px;"></i> Manage Categories
...
<?php
    ...
    elseif($do == 'Edit')
    {
        //Check If Request catid Is Numeric & Get The Integer Value Of It
                    ...
                    <div class="form-group form-group-lg row">
                        ...
                        <div class="col-sm-10 col-md-8">
                            <input type="text" name="name" class="form-control" placeholder="Name Of The Category" 
                                   value="<?php echo $cat['Name']; ?>" required="required" />
                        </div>
                    </div>
            <!--        End Name Field-->
